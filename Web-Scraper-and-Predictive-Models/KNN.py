...
# Step 3: Create and train the KNN model for Democrat results
model_democrat = KNeighborsRegressor(n_neighbors=5)  # You can adjust n_neighbors as needed
...
# Step 6: Create and train the KNN model for Republican results
model_republican = KNeighborsRegressor(n_neighbors=5)  # Adjust n_neighbors as necessary
...
results_df.rename(columns={'Predicted Democrat Result': 'KNN Dem'}, inplace=True)
results_df.rename(columns={'Predicted Republican Result': 'KNN Rep'}, inplace=True)
results_df.rename(columns={'Predicted Other Candidates Result': 'KNN Other'}, inplace=True)
results_df.rename(columns={'Winner': 'KNN Winner'}, inplace=True)
